...
from cypher_func import generate_hash, text_encryptor
from binary_manipulators import convert_into_binary
...
class DBCursor:
    ...
    def unselect_tag(self, tag_name):
        ...
        query = """DELETE FROM `Intermediate` WHERE Tag_ID=? AND User_ID=?"""
        data_tuple = (tag_id, self.user_info.user_id,)
