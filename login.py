...
class LoginWindowSerialize(QDialog, login_window.Ui_login_dialog):
    def __init__(self):
        super(LoginWindowSerialize, self).__init__()
        self.setupUi(self)
    ...
    def make_serialization(self):
        if self.window_mode == 0:
            temp_window = LoginSerialization()
            return temp_window
        elif self.window_mode == 1:
            temp_window = SignUpSerialization()
            return temp_window
        elif self.window_mode == 2:
            temp_window = EditUserInfo()
            return temp_window

class LoginSerialization(LoginWindowSerialize):
    def __init__(self):
        super(LoginSerialization, self).__init__()
    ...
    def init_edit_elements(self):
        ...
        self.user_name.setText('skaldson')
...
class SignUpSerialization(LoginWindowSerialize):
    def __init__(self):
        super(SignUpSerialization, self).__init__()
...
class EditUserInfo(SignUpSerialization):
