...
class EditSection(QWidget, edit_section.Ui_Form):
    ...
    def submit_edit(self):
        ...
        # print(self.premordial_list)
        # print(self.get_forms_values())
        if result_dict:
...
# перевизначити видалення тегу, зробити дамп таблиці тегів 
# у випадку, якщо потрібно скасувати зміни
# придумати нові функції
